-- Revert chat messages to be publicly viewable
DROP POLICY IF EXISTS "Users can only view chat messages in their city" ON public.chat_messages;
...
ADD COLUMN contact_hidden boolean DEFAULT false;
