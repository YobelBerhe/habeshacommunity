      ...
      <header className="bg-white shadow-sm fixed top-0 left-0 right-0 z-50">
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="hidden md:flex items-center justify-center flex-1 gap-2">
            <a href="/" className="px-12 h-14 flex items-center justify-center border-b-4 border-transparent text-gray-500 hover:bg-gray-100 rounded-lg">
        ...
        <div className="flex">
          ...
          <aside className="hidden xl:block w-[360px] fixed right-0 h-[calc(100vh-56px)] overflow-y-auto pt-4 px-4">
            ...
            <div>
              ...
              <div className="space-y-1">
                {['Dr. Mekdes Haile', 'Dr. Dawit Bekele', 'Nurse Sara Yohannes'].map((name, idx) => (
                  <a 
                    key={idx}
                    href="#"
