    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8 text-center">
          <Droplets className="h-16 w-16 mx-auto mb-4 text-blue-500" />
          <h1 className="text-2xl font-bold mb-2">Hydration Tracking</h1>
          <p className="text-muted-foreground mb-4">Track your daily water intake</p>
