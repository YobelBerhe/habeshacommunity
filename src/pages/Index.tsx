      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="text-center py-8 border-t bg-muted/30 rounded-lg mb-8">
          ...
          <div className="flex justify-center gap-6 flex-wrap">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/@HabeshaComm" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" title="YouTube">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/habeshacomm/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" title="Instagram">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* TikTok */}
            <a href="https://www.tiktok.com/@habeshacommunityofficial" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" title="TikTok">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/Habeshacomm/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" title="Facebook">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
