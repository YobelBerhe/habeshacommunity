// /lib/taxonomy.ts
export type CategoryKey = "housing" | "jobs" | "services" | "community" | "mentor" | "health" | "forsale" | "match";
...
> = {
  ...
  health: {
    name: { en: "Health", ti: "ጥዕና" },
    sub: [
      "fitness","nutrition","sleep","hydration","mental_health","wellness",
    ],
  },
  forsale: {
